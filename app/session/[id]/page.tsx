          ...
          <div className="flex items-center justify-between gap-2 mb-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={handleExportCSV} disabled={expenses.length === 0}
                className={`flex items-center gap-1 text-xs rounded-lg px-2.5 py-1.5 transition border disabled:opacity-40 ${headerImage ? 'text-gray-700 border-gray-400/60 bg-black/10 hover:bg-black/20 dark:text-white dark:border-white/40 dark:bg-white/10 dark:hover:bg-white/20' : 'text-gray-600 dark:text-gray-300 border-gray-300 dark:border-gray-600 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700/50 dark:hover:bg-gray-700'}`}
                title="Export to CSV">
                <Download size={12} />
              </button>
              {user ? (
              ...
              <button
                ...
                className={`text-xs px-2.5 py-0.5 rounded-full border transition ${
                  !filterMemberId
                    ...
                    : headerImage
                      ? 'border-gray-400/60 text-gray-700 bg-black/10 hover:bg-black/20 hover:border-gray-600 dark:border-white/40 dark:text-white/80 dark:bg-white/10 dark:hover:bg-white/20 dark:hover:border-white/70'
